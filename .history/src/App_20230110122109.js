...
export default function App() {
    ...
    return (
        <div style={{display: "block", width: WIDTH, maxWidth: "90%", margin: "50px auto", marginBottom: "10px", border: "#C9FA75", borderWidth: "thick", borderColor: "C9FA75"}}>
            <div><img src="header.png" width={WIDTH} /></div> 

...
export default function App() {
    ...
    return (
        <div style={{display: "block", border: "#C9FA75", width: "800px", maxWidth: "90%", margin: "50px auto", marginBottom: "10px", backgroundColor: "white"}}>
            <div><img src="https://media.discordapp.net/attachments/1047420970371121153/1062244702700711996/Header.png?width=800&height=448" /></div> 
            <Message info style={{textAlign: "center", color: "black"}}>
            ...
            <Message info style={{color: "black"}}>

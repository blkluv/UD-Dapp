...
export default function App() {
    ...
    return (
        <div style={{display: "block", width: "717px", maxWidth: "90%", margin: "50px auto", marginBottom: "10px", border: "#C9FA75", borderWidth: "thick", borderColor: "C9FA75"}}>
            ...
            <Message info style={{float: 'left', textAlign: "left", color: "black", backgroundColor: "white", border: "#C9FA75", borderWidth: "thick", borderColor: "C9FA75"}}>
            ...
            <Message info style={{float: 'left', color: "black", backgroundColor: "white", border: "#C9FA75", borderWidth: "thick", borderColor: "C9FA75", textAlign: "left"}}>

...
export default function App() {
    ...
    return (
        <div style={{display: "block", width: "717px", maxWidth: "90%", margin: "50px auto", marginBottom: "10px", border: "#C9FA75", borderWidth: "thick", borderColor: "C9FA75"}}>
            <div style={{maxWidth: "100%", height: auto}}><img src="https://media.discordapp.net/attachments/1047420970371121153/1062251157063475230/Header.png?width=717&height=448" class="responsive"/></div> 

...
export default function App() {
    ...
    return (
        <div style={{display: "block", width: "100%", maxWidth: "90%", margin: "50px auto", marginBottom: "10px", border: "#C9FA75", borderWidth: "thick", borderColor: "C9FA75"}}>
            <div>
            <Image src='https://media.discordapp.net/attachments/1047420970371121153/1062251157063475230/Header.png' 
                size='massive' 
                centered 
            ...
            <Message info style={{width: "100%",color: "black", backgroundColor: "white", border: "#C9FA75", borderWidth: "thick", borderColor: "C9FA75"}}>

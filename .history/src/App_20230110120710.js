...
export default function App() {
    ...
    return (
        <div style={{display: "block", width: "800px", maxWidth: "90%", margin: "50px auto", marginBottom: "10px", border: "#C9FA75", borderWidth: "thick"}}>
            ...
            <Message info style={{textAlign: "center", color: "black", backgroundColor: "white", border: "#C9FA75", borderWidth: "thick"}}>
            ...
            <Message info style={{color: "black", backgroundColor: "white", border: "#C9FA75", borderWidth: "thick"}}>
